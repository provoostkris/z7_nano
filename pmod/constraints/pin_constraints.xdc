...
set_property IOSTANDARD LVCMOS33 [get_ports {leds[0]}]
    -- PMOD SEG
set_property PACKAGE_PIN V16 [get_ports {seg[7]}]
set_property PACKAGE_PIN V15 [get_ports {seg[6]}]
set_property PACKAGE_PIN U14 [get_ports {seg[5]}]
set_property PACKAGE_PIN U13 [get_ports {seg[4]}]
set_property PACKAGE_PIN T12 [get_ports {seg[3]}]
set_property PACKAGE_PIN W14 [get_ports {seg[2]}]
set_property PACKAGE_PIN V12 [get_ports {seg[1]}]
set_property PACKAGE_PIN T14 [get_ports {seg[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {seg[0]}]
    -- PMOD LCD
set_property PACKAGE_PIN P18      [get_ports cs]
set_property PACKAGE_PIN R17      [get_ports sda]
set_property PACKAGE_PIN R18      [get_ports sck]
